...
mobileFix.href='mobile-fixes.css?v=12';
document.head.appendChild(mobileFix);

document.querySelectorAll('.brand').forEach((brand)=>{
  brand.innerHTML='<img class="combined-header-logo" src="assets/logo-base.svg?v=12" alt="아둘빠 책방 — 아들 둘 아빠가 시작한 우리 아이 이야기">';
...
if(homeCover){
  ...
  image.src='assets/sample-book-rubiya-cover.svg?v=12';
...
if(storyCover){
  ...
  storyCover.innerHTML='<img class="story-cover-image" src="assets/sample-book-rubiya-cover.svg?v=12" alt="루비야, 동화 속으로 데려다줘 실제 표지">';
}
